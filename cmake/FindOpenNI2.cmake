...
# OPENNI2_DEFINITIONS - Compiler flags for OPENNI.
...
find_path(OPENNI2_INCLUDE_DIR OpenNI.h
    HINTS ${PC_OPENNI2_INCLUDEDIR} ${PC_OPENNI2_INCLUDE_DIRS} /usr/include/ni /usr/include/openni2
    "${PROGRAMFILES_}/OpenNI2/Include"
    PATH_SUFFIXES openni2)
#add a hint so that it can find it without the pkg-config
find_library(OPENNI2_LIBRARY 
    NAMES OpenNI264 OpenNI2
    HINTS ${PC_OPENNI2_LIBDIR} ${PC_OPENNI2_LIBRARY_DIRS} /usr/lib /usr/lib/OpenNI2 "${PROGRAMFILES_}/OpenNI2/Lib${OPENNI2_SUFFIX}")
